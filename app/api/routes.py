...
def _article_generation_response(draft: ContentArticleDraft, endpoint_used: str) -> dict[str, object]:
    ...
    diagnostics = {
        ...
        "router_reason": debug.get("router_reason"),
        "contract_validation_status": debug.get("contract_validation_status"),
...
def _draft_debug(draft: ContentArticleDraft, slug_source: str = "title") -> dict[str, object]:
    ...
    return {
        ...
        "selected_contract": topic_profile.get("selected_topic_contract") or topic_profile.get("topic_type"),
        "selected_article_contract": topic_profile.get("selected_contract"),
        "article_contract": topic_profile.get("article_contract"),
        "detected_intent": topic_profile.get("detected_intent"),
        "router_reason": topic_profile.get("router_reason"),
        "contract_validation_status": topic_profile.get("contract_validation_status"),
